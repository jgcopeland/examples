...
int countBinOnes(int num) {
    ...
    //Bitwise - slow, can't see way of doing without looping
    int numOnes = 0; //initialize counter to 0
    for(int i = log2(num)+1; i >= 0; i--) { //loop through each position in the binary number log2(num) = binarylength of num
